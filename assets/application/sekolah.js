function getSekolah() {
    var table = $('#tblsekolah').DataTable({
        ...
        "ajax": {
            "url": getbasepath() + "dashboard/sekolah/listsekolah",
            "type": "POST",
            "data": function (d) {
                d.kecamatan = getKec2();
...
function tambahData() {
    $.ajax({
        url: getbasepath() + "dashboard/sekolah/tambahData",
        type: "GET",
...
function ubahData(id) {
    $.ajax({
        url: getbasepath() + "dashboard/sekolah/getDialogubah/" + id,
        type: "GET",
        dataType: "JSON",
        success: function (data) {
            $('#modalubahdata').modal({
...
function uploadFile() {
    ...
    if (a == true) {
        ...
        var loop1 = 0;
        $.ajax({
            url: getbasepath() + 'dashboard/sekolah/getDataProfile/', // point to server-side controller method
...
function importData() {
    $.ajax({
        url: getbasepath() + "dashboard/sekolah/getDialogImport",
        type: "GET",
        success: function (data) {
...
function simpanData() {
    ...
    $.ajax({
        type: "POST",
        url: getbasepath() + "dashboard/sekolah/simpanData",
