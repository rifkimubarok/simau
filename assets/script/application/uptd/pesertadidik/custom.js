...
function getSiswa() {
      var table =   $('#tblpesertadidik').DataTable({
          ...
          "ajax": {
              "url": getbasepath()+"uptd/Pesertadidik/listPesertaDidik",
              "type": "POST",
              "data" :function(d) {
                d.npsn = getNpsn();
              }
...
function getSekolah(){
  $.ajax({
    url:getbasepath()+"uptd/Pesertadidik/getSekolah",
    type:"GET",
    dataType:"JSON",
...
function getKec(){
  $.ajax({
    url:getbasepath()+"uptd/Pesertadidik/getKec",
    type:"GET",
    dataType:"JSON",
    success:function(data){
        console.log(data);
...
function getJenjang(){
  $.ajax({
    url:getbasepath()+"uptd/Pesertadidik/getJenjang",
    type:"GET",
    dataType:"JSON",
    success:function(data){
        console.log(data);
