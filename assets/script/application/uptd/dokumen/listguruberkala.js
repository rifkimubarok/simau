...
function getguru() {
      var table =   $('#tblguru').DataTable({
          ...
          "ajax": {
              "url": getbasepath()+"pengelola/guru/listguruberkala",
              "type": "POST",
              "data":function(d) {
                  d.npsn = getNpsn();
                  d.bulan = getBulan();
...
function printexcel() {
    window.location.href=getbasepath()+"pengelola/guru/cetak_excelberkala?bulan="+getBulan()+"&tahun="+getTahun()+"&npsn="+getNpsn();
}