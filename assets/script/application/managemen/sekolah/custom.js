...
function getSekolah() {
      var table =   $('#tblsekolah').DataTable({
          ...
          "ajax": {
              "url": getbasepath()+"managemen/Sekolah/listsekolah",
              "type": "POST",
              "data" :function(d) {
                d.kecamatan = getKec2();
              }
...
function tambahData() {
    $.ajax({
        url:getbasepath()+"managemen/Sekolah/tambahData",
        type:"GET",
        success:function(data) {
...
function ubahData(id){
  $.ajax({
    url:getbasepath()+"managemen/Sekolah/getDialogubah/" + id,
    type: "GET",
    dataType: "JSON",
    success:function(data){
...
function uploadFile(){
  ...
  if(a == true){
    $('#progresstext').text(" ");
        ...
        var loop1 =0;
        $.ajax({
            url: getbasepath()+'managemen/Sekolah/getDataProfile/', // point to server-side controller method
...
function importData(){
  $.ajax({
    url:getbasepath()+"managemen/Sekolah/getDialogImport",
    type: "GET",
    success:function(data){
...
function simpanData() {
    ...
    $.ajax({
        type: "POST",
        url: getbasepath() + "managemen/Sekolah/simpanData",
