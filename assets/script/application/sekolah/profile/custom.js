...
function uploadFile(){
  ...
  if(a == true){
    $('#progresstext').text(" ");
        ...
        var loop1 =0;
        $.ajax({
            url: getbasepath()+'sekolah/Profile/getDataProfile/', // point to server-side controller method
...
function importData(){
  $.ajax({
    url:getbasepath()+"sekolah/Profile/getDialogImport",
    type: "GET",
...
function simpanData() {
   ...
   var icon = '';
    ...
    $.ajax({
        type: "POST",
        url: getbasepath() + "sekolah/Profile/simpanData",
        ...
        dataType: "JSON",
        success:function(data) {
            alert('Profile Sekolah Berhasil Diperbaharui.');
        },
        error:function(error,x,y) {
...
function getProfile(){
    $.ajax({
        url:getbasepath()+"sekolah/Profile/getProfile",
        type:"POST",
        dataType:"JSON",
        success:function(data){
            if(data){
