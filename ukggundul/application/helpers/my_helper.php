...
function gen_menu1() {
	...
	if ($sess_level == "guru") {
	  ...
	  $menu = array(
	            array("icon"=>"dashboard", "url"=>"adm/", "text"=>"Dashboard"),
	            array("icon"=>"file", "url"=>"adm/ikuti_ujian", "text"=>"Ujian"),
	          );
	} else if ($sess_level == "admin") {
	  $menu = array(
	            array("icon"=>"dashboard", "url"=>"adm/", "text"=>"Dashboard"),
	            array("icon"=>"list-alt", "url"=>"adm/m_guru", "text"=>"Data Guru"),
	            array("icon"=>"list-alt", "url"=>"adm/m_user", "text"=>"Data User"),
	            array("icon"=>"list-alt", "url"=>"adm/m_mapel", "text"=>"Data Mapel"),
	            array("icon"=>"list-alt", "url"=>"modul/m_modul", "text"=>"Data Modul"),
	            array("icon"=>"list-alt", "url"=>"adm/m_soal", "text"=>"Soal"),
	            array("icon"=>"file", "url"=>"adm/h_ujian", "text"=>"Hasil Ujian"),
	          );
	} else {
