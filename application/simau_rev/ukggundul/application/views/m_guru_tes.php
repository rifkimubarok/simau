          ...
          <form name="f_ujian" id="f_ujian" onsubmit="return m_ujian_s();">
            ...
            <input type="hidden" name="jumlah_soal1" id="jumlah_soal1" value="0">
              <table class="table table-form">
                ...
                <tr>
                    <td>Modul</td>
                    <td><select class="form-control" id="jenjang" required="" name="jenjang"> <option value="">-- Pilih Jenjang --</option><option value="SD"> SD</option><option value="SMP"> SMP</option></select></td>
                </tr>
                <tr>
                    <td>Mata Pelajaran</td>
                    <td>
                        <?php echo form_dropdown('mapel', $p_mapel, '', 'onchange="return getModul();" class="form-control"  id="mapel" required'); ?>
                    </td>
                </tr>
                <tr>
                    <td>Modul</td>
                    <td><select class="form-control" id="modulpelajaran" required="" name="modulpelajaran" onchange="return __ambil_jumlah_soal(this.value);"> <option value="">-- Pilih Modul --</option></select></td>
                </tr>
                <tr>
                    <td>Jumlah soal</td>
                    <td>
