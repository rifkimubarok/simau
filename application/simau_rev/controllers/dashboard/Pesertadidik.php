...
class Pesertadidik extends CI_Controller
{
	...
	function index(){
        $this->template->display('dashboard/pesertadidik/pesertadidik');
	}

	function test(){
		$this->template->display('uptd/pesertadidik/formPesertaDidik');
	}
	...
	public function getDialogImport(){
		$this->load->view('dashboard/pesertadidik/importPesertadidik');
	}
