...
class Guru extends CI_Controller
{
    ...
    function info(){
        $this->template->display("dashboard/grafik/grafikUmurGuru");
    }
	...
	function infoGrafPangkat(){
		$this->template->display("dashboard/grafik/grafikPangkat");
	}

    function infoBerkala(){
        $this->template->display("dashboard/dokumen/listguruberkala");
    }

	function infoPangkat(){
		$this->template->display("dashboard/dokumen/listgurupangkat");
	}
