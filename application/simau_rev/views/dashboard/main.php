<div id="page-wrapper">
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div>SMP</div>
                                    <div class="huge"><?php echo $SMP; ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div class="huge"><?php echo $Total_Sekolah; ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div>Total Murid</div>
                                    <div class="huge"><?php echo $JmlLaki + $JmlPerempuan; ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <script type="text/javascript" src="<?php echo base_url(); ?>assets/application/grafikHome.js"></script>
</div>    