<div id="page-wrapper">
    <div class="row">
        <div class="col-md-12">
            <h1 class="page-header">NILAI UN</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12 col-md-6">
            <div class="panel panel-default">
                ...
                <div class="form-group col-md-2">
                    ...
                    <p class="text-right"><button class="btn btn-outline btn-primary" onclick="importData()"><i class="fa fa-file-excel-o"></i>  Import Nilai UN SMPN </button></p>
                </div>
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/application/nilai.js"></script>
