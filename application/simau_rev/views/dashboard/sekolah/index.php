        ...
        <div class="col-lg-12 col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <p align="right"><button class="btn btn-outline btn-primary" onclick="tambahData()"><i class="fa fa-file-excel-o"></i>  Tambah Sekolah </button></p>
                </div>
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/application/sekolah.js"></script>
...
<div class="modal fade in" id="modalubahdata" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Ubah Data Sekolah <i class="fa fa-file-excel-o"></i></h4>
          </div>
          <form method="post" action="<?php echo base_url().'dashboard/sekolah/fixubah'?>">
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12 col-md-6">
                        <div class="panel panel-default">
