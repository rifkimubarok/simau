        ...
        <div class="panel panel-default">
          <div class="panel-body">
            <table class="table table-bordered">
              ...
              <tr><td>Nomor Peserta</td><td><?php echo $dp['nim']; ?></td></tr>
              <tr><td>Mapel / Modul</td><td><?php echo $du['nmmapel'].' '.$du['modul']; ?></td></tr>
...
<div class="modal fade" id="m_failed" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-sm modal-danger" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 id="myModalLabel">Notifikasi</h4>
      </div>
      <div class="modal-body">
            <p>
               Token Yang Anda Masukan Salah.
            </p>
      </div>
