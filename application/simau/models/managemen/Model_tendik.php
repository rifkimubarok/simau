...
class Model_tendik extends CI_Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->join('tbl_sekolah','tbl_sekolah.npsn = tbl_tendik.kode_sekolah');
    ...
    private function _get_datatables_query1()
    {
        ...
        $this->db->join("v_umurtendik2 b",'on a.id = b.id ','inner');
    ...
    {
        if(isset($_POST['npsn']) && $_POST['npsn'] != ''){
        $where = array("a.kode_sekolah"=>$_POST['npsn'],"b.umur"=>"58");
        $this->db->where($where);
        }else{
    ...
    function getstatus()
    {
        $this->db->select('id,stat_kepegawaian');
        $hasil = $this->db->get('tbl_tendik');
        return $hasil->result();
    }
    function getKab()
    {
    ...
    function _get_custom_field2()
    {
        ...
        if(isset($_POST['bulan']) && isset($_POST['tahun']) && $_POST['bulan'] != '' && $_POST['tahun'] != ""){
            $kondisi = array("jabatan"=>"TENDIK","MONTH(tgl_berkala)"=>$_POST['bulan'],"YEAR(tgl_berkala)"=>$_POST['tahun']);
            $where = $kondisi;
        }else if (isset($_POST['bulan']) && isset($_POST['tahun']) && $_POST['bulan'] != '' && $_POST['tahun'] == '') {
            $kondisi = array("jabatan"=>"TENDIK","MONTH(tgl_berkala)"=>$_POST['bulan']);
            $where = $kondisi;
        }else if (isset($_POST['bulan']) && isset($_POST['tahun']) && $_POST['bulan'] == '' && $_POST['tahun'] != '') {
            $kondisi = array("jabatan"=>"TENDIK","YEAR(tgl_berkala)"=>$_POST['tahun']);
            $where = $kondisi;
        }else{
            $where = array("jabatan"=>'TENDIK');
        }
        if(isset($_POST['npsn']) && $_POST['npsn'] != ''){
    ...
    public function getAllDataBerkala()
    {
        ...
        if(isset($_GET['bulan']) && isset($_GET['tahun']) && $_GET['bulan'] != '' && $_GET['tahun'] != ""){
            $kondisi = array("jabatan"=>"TENDIK","MONTH(tgl_berkala)"=>$_GET['bulan'],"YEAR(tgl_berkala)"=>$_GET['tahun']);
            $where = $kondisi;
        }else if (isset($_GET['bulan']) && isset($_GET['tahun']) && $_GET['bulan'] != '' && $_GET['tahun'] == '') {
            $kondisi = array("jabatan"=>"TENDIK","MONTH(tgl_berkala)"=>$_GET['bulan']);
            $where = $kondisi;
        }else if (isset($_GET['bulan']) && isset($_GET['tahun']) && $_GET['bulan'] == '' && $_GET['tahun'] != '') {
            $kondisi = array("jabatan"=>"TENDIK","YEAR(tgl_berkala)"=>$_GET['tahun']);
            $where = $kondisi;
        }else{
            $where = array("jabatan"=>'TENDIK');
        }
    ...
    public function getAllDataPangkat()
    {
        $where = array();
        if(isset($_GET['bulan']) && isset($_GET['tahun']) && $_GET['bulan'] != '' && $_GET['tahun'] != ""){
            $kondisi = array("jabatan"=>"TENDIK","MONTH(tgl_pangkat)"=>$_GET['bulan'],"YEAR(tgl_pangkat)"=>$_GET['tahun']);
            $where = $kondisi;
        }else if (isset($_GET['bulan']) && isset($_GET['tahun']) && $_GET['bulan'] != '' && $_GET['tahun'] == '') {
            $kondisi = array("jabatan"=>"TENDIK","MONTH(tgl_pangkat)"=>$_GET['bulan']);
            $where = $kondisi;
        }else if (isset($_GET['bulan']) && isset($_GET['tahun']) && $_GET['bulan'] == '' && $_GET['tahun'] != '') {
            $kondisi = array("jabatan"=>"TENDIK","YEAR(tgl_pangkat)"=>$_GET['tahun']);
            $where = $kondisi;
        }else{
            $where = array("jabatan"=>'TENDIK');
        }
    ...
    function _get_custom_field3()
    {
        $where = array();
        if(isset($_POST['bulan']) && isset($_POST['tahun']) && $_POST['bulan'] != '' && $_POST['tahun'] != ""){
            $kondisi = array("jabatan"=>"TENDIK","MONTH(tgl_pangkat)"=>$_POST['bulan'],"YEAR(tgl_pangkat)"=>$_POST['tahun']);
            $where = $kondisi;
        }else if (isset($_POST['bulan']) && isset($_POST['tahun']) && $_POST['bulan'] != '' && $_POST['tahun'] == '') {
            $kondisi = array("jabatan"=>"TENDIK","MONTH(tgl_pangkat)"=>$_POST['bulan']);
            $where = $kondisi;
        }else if (isset($_POST['bulan']) && isset($_POST['tahun']) && $_POST['bulan'] == '' && $_POST['tahun'] != '') {
            $kondisi = array("jabatan"=>"TENDIK","YEAR(tgl_pangkat)"=>$_POST['tahun']);
            $where = $kondisi;
        }else{
            $where = array("jabatan"=>'TENDIK');
        }
