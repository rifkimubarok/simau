...
class Model_siswa extends CI_Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->select('a.id,a.nisn,a.nipd,a.nama,a.jk,b.namasekolah,a.kelas,a.jurusan,a.buntut');
        $this->db->from($this->_table.' a');
        $this->db->join('tbl_sekolah b','b.npsn = a.kode_sekolah','inner');
    ...
    function _get_custom_field()
    {
            ...
            if (isset($_POST['npsn']) && $_POST['npsn'] != ""){
                $npsn = $_POST['npsn'];
                $this->db->where("a.kode_sekolah",$npsn);
            }
            $this->db->where(array("b.kecamatan"=>$kecamatan,'b.jenjang'=>$jenjang));
    }
    ...
    {   
        $kecamatan = $this->session->userdata('kecamatan');
        $jenjang = $this->session->userdata('npsn');
        $this->db->select('npsn, namasekolah, kecamatan, jenjang');
