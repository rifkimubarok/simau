...
<script type="text/javascript" src="<?php echo base_url() ?>assets/script/application/sekolah/guru/custom.js"></script>
...
<div class="modal fade in" id="modalubahdata" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md" style="width: 900px;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Ubah Data Guru<i class="fa fa-file-excel-o"></i></h4>
            </div>
            <div class="modal-body">
                 <div class="col-md-12">
                        <div class="">
                            <ul class="nav nav-tabs" role="tablist">
                              ...
                              <li><a data-toggle="tab" href="#menu1">Data Tambahan</a></li>
                            </ul>
                            ...
                            <div class="tab-content">
                                <div id="home" class="tab-pane fade in active">
                                  <br>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form id="form" method="post" role="form" action="<?php echo base_url().'sekolah/guru/ubah'?>">
                                           ...
                                           <label>Nama</label>
                                            ...
                                            <label>Kelurahan</label>
                                                <input class="form-control" type="text" name="desa" id="desa" placeholder="Kelurahan">
                                            </div>
                                            <div class="form-group col-lg-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <label>No Rekening Bank</label>
                                                <input class="form-control" type="text" name="no_rek" id="no_rek" placeholder="No Rekening Bank">
                                            </div>
                                            <div class="form-group col-lg-6">
