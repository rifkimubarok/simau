            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <div class="">
                            <table class="table table-striped table-bordered table-hover" id="tbljwb" width="100%">
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/script/application/managemen/jwbpd/custom.js"></script>
