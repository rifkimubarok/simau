                        ...
                        <div class="">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="tblrekap" width="100%">
                                <thead style="white-space: nowrap;">
                                    <tr>
                                        <th width="4%">No</th>
                                        <th width="10%" id="kab">Kecamatan</th>
                                        <th width="10%" id="kec">-</th>
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/script/application/uptd/rekap/custom.js"></script>
<style type="text/css">
