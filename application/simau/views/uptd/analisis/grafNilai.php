                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="col-md-12">
                                ...
                                <input type="hidden" id="kecamatan" value="<?php echo $this->session->userdata('kecamatan'); ?>">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/script/application/pengelola/grafik/analisisnilai.js"></script>
