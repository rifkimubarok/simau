...
<head>
    ...
    <title>UKG - SIMAU - DISPORA GUNUNG KIDUL</title>
...
<body>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; background-color: #bef092">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>pengelola"><span><img src="<?php echo base_url();?>assets/image/logo.png" width='24px' > <b>UKG dan SIMAU - DISPORA GUNUNG KIDUL</b></span></a>
            </div>
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-user fa-fw"></i> Selamat Datang, <?php echo $this->session->userdata('jabatan').' '.$this->session->userdata('kecamatan');
							?>
                        ...
                        <?php
                            if($this->session->userdata('level')=='5' || $this->session->userdata('level')=='6'){
                               ?>
                                ...
                                <li>
                                    <a href="<?php echo base_url(); ?>sekolah/banding_ukg""><i class="fa fa-home fa-bar-chart-o"></i> Grafik Banding Ujian</a>
                                </li>
                        <?php 
                            }
                        ?>
                        <?php
                            if($this->session->userdata('level')=='7' || $this->session->userdata('level')=='8'){
                               ?>
                                    <li>
    ...
    function login(){
        return "<?php echo $this->session->userdata('level'); ?>";
    }
    </script>
