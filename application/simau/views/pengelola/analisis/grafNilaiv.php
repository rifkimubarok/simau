                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="col-md-12">
                                ...
                                <div class="form-group col-md-2">
                                    <select class="form-control" id="kelas" onchange="reloadSekolah()"></select>
                                </div>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/script/application/pengelola/grafik/analisisnilaiv.js"></script>