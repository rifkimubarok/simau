...
class Tendik extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('uptd/Model_tendik','tendik');
		$this->load->library('Libkebutuhan');
	}

	 function index(){
		$this->template->display("uptd/tendik/listtendik");
	}

	function info(){
		$this->template->display("uptd/grafik/grafikUmurTendik");
	}

    function infoGrafPangkat(){
        $this->template->display("uptd/grafik/grafikPangkatTendik");
    }

	function infoDoc(){
		$this->template->display("uptd/dokumen/listtendik1");
	}

    function infoBerkala(){
        $this->template->display("uptd/dokumen/listtendikberkala");
    }

	function infoPangkat(){
		$this->template->display("uptd/dokumen/listtendikpangkat");
	}
	...
	function cetak_dokumen($kode_sekolah=null)
    {
        if($kode_sekolah!= null){
            ...
            /*$this->load->view('uptd/dokumen/print/tendikdoc',$data);*/
