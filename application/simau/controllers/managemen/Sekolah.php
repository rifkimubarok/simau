...
class Sekolah extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('managemen/model_profile','profile');
		$this->load->model('managemen/model_sekolah','sekolah');
	}

	 function index(){
		$this->template->display("managemen/sekolah/index");
	}
	...
	{
		$this->load->view('managemen/profile/profile');
	}
