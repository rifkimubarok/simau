...
class Pesertadidik extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('pengelola/Model_siswa','siswa');
		$this->load->library('Libkebutuhan');
	}

	function index(){
        $this->template->display('pengelola/pesertadidik/pesertadidik');
	}

	function test(){
		$this->template->display('pengelola/pesertadidik/formPesertaDidik');
	}
