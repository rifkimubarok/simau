...
class Sekolah extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('pengelola/model_profile','profile');
		$this->load->model('pengelola/model_sekolah','sekolah');
	}

	 function index(){
		$this->template->display("pengelola/sekolah/index");
	}
	...
	{
		$this->load->view('pengelola/profile/profile');
	}
