...
class Tendik extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('pengelola/Model_tendik','tendik');
		$this->load->library('Libkebutuhan');
	}

	 function index(){
		$this->template->display("pengelola/tendik/listtendik");
	}

	function info(){
		$this->template->display("pengelola/grafik/grafikUmurTendik");
	}

    function infoGrafPangkat(){
        $this->template->display("pengelola/grafik/grafikPangkatTendik");
    }

	function infoDoc(){
		$this->template->display("pengelola/dokumen/listtendik1");
	}

    function infoBerkala(){
        $this->template->display("pengelola/dokumen/listtendikberkala");
    }

	function infoPangkat(){
		$this->template->display("pengelola/dokumen/listtendikpangkat");
	}
