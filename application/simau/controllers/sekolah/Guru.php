...
class Guru extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('sekolah/Model_guru','guru');
		$this->load->library('Libkebutuhan');
	}

	 function index(){
		$this->template->display("sekolah/guru/listguru");
	}

	function infoDoc(){
		$this->template->display("sekolah/dokumen/listguru");
	}
	...
	function cetak_dokumen()
	{
		...
		/*$this->load->view('sekolah/dokumen/print/gurudoc',$data);*/
	...
	{
		$this->load->view('sekolah/guru/importguru');
	}
